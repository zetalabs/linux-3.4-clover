...
static int __devinit sun7i_i2s_pcm_probe(struct platform_device *pdev)
{
	return snd_soc_register_platform(&pdev->dev, &sun7i_soc_platform);
}

static int __devexit sun7i_i2s_pcm_remove(struct platform_device *pdev)
{
...
/*data relating*/
static struct platform_device sun7i_i2s_pcm_device = {
	.name = "sun7i-i2s-pcm-audio",
};

/*method relating*/
static struct platform_driver sun7i_i2s_pcm_driver = {
	.probe = sun7i_i2s_pcm_probe,
	.remove = __devexit_p(sun7i_i2s_pcm_remove),
	.driver = {
		.name = "sun7i-i2s-pcm-audio",
		.owner = THIS_MODULE,
	},
...
static void __exit sun7i_soc_platform_i2s_exit(void)
{
	return platform_driver_unregister(&sun7i_i2s_pcm_driver);
}
module_exit(sun7i_soc_platform_i2s_exit);
