...
static DEVICE_ATTR(enable, 0664, mma8452_enable_show, mma8452_enable_store);		
static DEVICE_ATTR(delay, 0664, mma8452_delay_show, mma8452_delay_store);
