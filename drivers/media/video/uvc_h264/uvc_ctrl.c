...
// RERVISION Extension Unit GUID
#define UVC_GUID_RERVISION_SYS_HW_CTRL				{0x70, 0x33, 0xf0, 0x28, 0x11, 0x63, 0x2e, 0x4a, 0xba, 0x2c, 0x68, 0x90, 0xeb, 0x33, 0x40, 0x16}	//Extension Unit 3
#define UVC_GUID_RERVISION_USR_HW_CTRL				{0x94, 0x73, 0xDF, 0xDD, 0x3E, 0x97, 0x27, 0x47, 0xBE, 0xD9, 0x04, 0xED, 0x64, 0x26, 0xDC, 0x67}	//Extension Unit 4
//#define UVC_GUID_RERVISION_USR_HW_CTRL				{0x3F, 0xAE, 0x12, 0x28, 0xD7, 0xBC, 0x11, 0x4E, 0xA3, 0x57, 0x6F, 0x1E, 0xDE, 0xF7, 0xD6, 0x1D}	//Extension Unit 4
...
#define V4L2_CID_FRAME_INFO_RERVISION				V4L2_CID_BASE_RERVISION+2
#define V4L2_CID_H264_CTRL_RERVISION				V4L2_CID_BASE_RERVISION+3
#define V4L2_CID_MJPG_CTRL_RERVISION				V4L2_CID_BASE_RERVISION+4
#define V4L2_CID_OSD_CTRL_RERVISION					V4L2_CID_BASE_RERVISION+5
#define V4L2_CID_MOTION_DETECTION_RERVISION			V4L2_CID_BASE_RERVISION+6
#define V4L2_CID_IMG_SETTING_RERVISION				V4L2_CID_BASE_RERVISION+7
#define V4L2_CID_MULTI_STREAM_CTRL_RERVISION		V4L2_CID_BASE_RERVISION+8
#define V4L2_CID_GPIO_CTRL_RERVISION				V4L2_CID_BASE_RERVISION+9
#define V4L2_CID_DYNAMIC_FPS_CTRL_RERVISION			V4L2_CID_BASE_RERVISION+10
#define V4L2_CID_LAST_EXTCTR_RERVISION				V4L2_CID_DYNAMIC_FPS_CTRL_RERVISION

// ----------------------------- XU Control Selector ------------------------------------
#define XU_RERVISION_SYS_ASIC_READ      			0x01
...
#define LENGTH_OF_RERVISION_XU						(11)
#if 0
// mapping for RERVISION XU system ctrls
...
{
    {
      ...
      .selector  = XU_RERVISION_SYS_ASIC_READ,
      .size      = 4,
      .offset    = 0,
      .v4l2_type = V4L2_CTRL_TYPE_INTEGER,
      .data_type = UVC_CTRL_DATA_TYPE_SIGNED
...
// mapping for RERVISION XU user ctrls
...
int uvc_xu_ctrll_ReadChip(struct uvc_device *dev, int *chip)
{
	...
	*chip = CHIP_NONE;
	...
	ret = uvc_query_ctrl(dev,UVC_SET_CUR, 3, dev->intfnum, XU_RERVISION_SYS_ASIC_READ, ctrldata, 4);
	...
	// Asic Read
	ctrldata[3] = 0x00;
	ret = uvc_query_ctrl(dev,UVC_GET_CUR, 3, dev->intfnum, XU_RERVISION_SYS_ASIC_READ, ctrldata, 4);
	if(ret < 0)
	{
	...
	if(ctrldata[2] == RERVISION_RER9420_SERIES_CHIPID)
	{
		*chip = CHIP_RER9420;
	}	
	if(ctrldata[2] == RERVISION_RER9422_SERIES_CHIPID)
	{
		...
		if(ctrldata[2] == RERVISION_RER9422_DDR_64M)
			*chip = CHIP_RER9422;
		else if(ctrldata[2] == RERVISION_RER9422_DDR_16M)
			*chip = CHIP_RER9421;			
	}
